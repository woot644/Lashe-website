    ...
    <>
      ...
      <section className="bg-sage-50 py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sage font-medium text-sm tracking-wide uppercase mb-3">For Practitioners</p>
          <h1
            ...
            {tiers.map((tier) => (
              <div
                ...
                className={`rounded-xl p-6 ${
                  tier.highlighted
                    ? "bg-sage text-white border-2 border-sage ring-4 ring-sage/10"
                ...
                <div className="space-y-2.5 mb-6">
                  {tier.features.map((f) => (
                    <div key={f} className="flex items-start gap-2">
                      <CheckCircle
                        size={14}
                        className={`shrink-0 mt-0.5 ${tier.highlighted ? "text-white/80" : "text-sage"}`}
                      />
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.step} className="flex items-start gap-4 bg-cream rounded-xl p-5">
                <div className="w-8 h-8 rounded-full bg-sage text-white flex items-center justify-center text-sm font-semibold shrink-0">
                  {item.step}
                </div>
                <div>
      ...
      <section className="py-16 sm:py-20 bg-[#2c2c2c]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-sage hover:bg-sage-light text-white font-medium px-8 py-3 rounded-lg transition-colors"
          >
